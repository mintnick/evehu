...
module.exports = async function (app) {
    ...
    setRedis(app, 'new_alliances', 'select alliance_id id, name, date_founded birthday, member_count, diff_7days from alliances  order by date_founded desc limit 10');
    ...
    setRedis(app, 'new_corporations', 'select corporation_id id, alliance_id, date_founded birthday, name, member_count, diff_7days from corporations order by date_founded desc limit 10');

    setRedis(app, 'new_characters', 'select character_id id, alliance_id, corporation_id, name, birthday from characters order by birthday desc limit 10');
